        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-normal mt-0.5">
              Empirical simulation comparing naive retries against PaySentinel deterministic policy guardrails.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-3 gap-2">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5 font-normal">
              Empirical benchmark evaluation comparing naive blind retry logic against PaySentinel safety guardrails.
            </p>
          </div>
            ...
            <tbody className="divide-y divide-gray-100 font-sans">
              ...
              <tr className="bg-emerald-50/40 hover:bg-emerald-50/70 font-medium">
                <td className="py-3.5 px-4 font-bold text-emerald-950 flex items-center gap-1.5">
                  ...
                  PaySentinel Engine (Guardrailed)
                </td>
